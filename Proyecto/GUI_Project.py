...
from Tkinter import * #Para python 3.x.x debes importar como: tkinter
#from Tkinter import messagebox <-- ON PYTHON 3.xx
import tkMessageBox
gui = Tk() #Instancia de la interfaz


def imprimir():
	a = tkMessageBox.askyesno("Mensaje","El mensaje es:"+mensaje.get())	
	if a == True:
		print "Fue verdadera"
	else:
		print "False"
...
buttonSHOW = Button (gui, text = "to show",command=imprimir).place(x=40,y=150)
